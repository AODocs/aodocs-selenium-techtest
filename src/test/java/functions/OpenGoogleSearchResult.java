...
public class OpenGoogleSearchResult {
    ...
    public static void openAodocsResult(WebDriver driver, String searchString){
        ...
        Boolean compareResult = validations.Urls.urlParts(driver, protocol, subDomain, domainName, topLevelDomain, null, null, null).getResult();
        String aodocsUrlString = validations.Urls.urlParts(driver, protocol, subDomain, domainName, topLevelDomain, null, null, null).getUrl();
